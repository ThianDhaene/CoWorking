    ...
    <main class="container">
        <div class="product-container">
            ...
            <div class="right-column">
                <h2 class="product-title"><span class="about">i</span><span class="about">e</span><span class="about">t</span><span class="about">s</span><span class="about">g</span><span class="about">e</span><span class="about">n</span><span class="about">t</span><span class="about">s</span> <span class="about">l</span><span class="about">i</span><span class="about">g</span><span class="about">h</span><span class="about">t</span><span class="about">e</span><span class="about">r</span>
</h2>
                <div class="average-rating">
                          <p><?php echo generateStars($averageRating); ?></p>
                </div>
                <span class="product-price" data-original-price="25.00">4.99</span>

                <p class="product-description">Ignite your style with the ietsgents Minimalistic Lighter. Sleek and sophisticated, this lighter combines functionality with a clean design. Elevate your everyday essentials with the ietsgents Minimalistic Lighter, a perfect blend of form and utility.</p>
