    ...
    <main class="container">
        <div class="product-container">
            ...
            <div class="right-column">
                ...
                <p class="product-description">Lessig je dorst naar stijl met de ietsgents Minimalistic Bottle. Vervaardigd met een strak ontwerp en hoogwaardige materialen, combineert deze fles moeiteloos vorm en functie. Blijf gehydrateerd in stijl met de ietsgents Minimalistic Bottle - waar elegantie samensmelt met alledaagse functionaliteit.</p>
