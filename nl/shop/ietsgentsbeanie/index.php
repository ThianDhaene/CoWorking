    ...
    <main class="container">
        <div class="product-container">
            ...
            <div class="right-column">
                <h2 class="product-title"><span class="about">i</span><span class="about">e</span><span class="about">t</span><span class="about">s</span><span class="about">g</span><span class="about">e</span><span class="about">n</span><span class="about">t</span><span class="about">s</span> <span class="about">b</span><span class="about">e</span><span class="about">a</span><span class="about">n</span><span class="about">i</span><span class="about">e</span>
</h2>
                ...
                <p class="product-description">Blijf stijlvol warm met de ietsgents minimalistische beanie. Dit knusse essentiële item omarmt eenvoud met een strak ontwerp, wat zorgt voor een slanke en veelzijdige toevoeging aan je wintergarderobe. Verhoog je winterse uitstraling met de ietsgents minimalistische beanie, waar comfort samensmelt met minimalistische elegantie.</p>
            ...
            <div class="reviews">
              <div class="add-review">
                <form method="post" action="<?php echo $_SERVER["PHP_SELF"]; ?>">
                    ...
                    <br>
                    <input type="submit" name="submit_review" value="Verstuur">
                </form>
              </div>
