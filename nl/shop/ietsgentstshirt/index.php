    ...
    <main class="container">
        <div class="product-container">
            ...
            <div class="right-column">
                ...
                <h2 class="product-title"><span class="about">i</span><span class="about">e</span><span class="about">t</span><span class="about">s</span><span class="about">g</span><span class="about">e</span><span class="about">n</span><span class="about">t</span><span class="about">s</span> <span class="about">t</span><span class="about">s</span><span class="about">h</span><span class="about">i</span><span class="about">r</span><span class="about">t</span>
</h2>
                <div class="average-rating">
                          <p><?php echo generateStars($averageRating); ?></p>
                </div>
                <span class="product-price" data-original-price="25.00">19.99 EUR</span>

                <p class="product-description">Verhoog je alledaagse stijl met het ietsgents Minimalistic T-Shirt. Ongecompliceerd maar verfijnd, pronkt dit shirt met een strak ontwerp en een comfortabele pasvorm. Omarm eenvoud zonder sophisticatedheid op te offeren - herdefinieer casual met het ietsgents Minimalistic T-Shirt.</p>
