...
<body>
    <header class="container">
        ...
        <ul>
            ...
            <li><a href="../../cart"><img src="../../img/winkelmandje.webp" class="cart" alt="car"></a></li>
        </ul>
    </header>
    <main class="container">
        <div class="product-container">
            ...
            <div class="right-column">
                <h2 class="product-title"><span class="about">i</span><span class="about">e</span><span class="about">t</span><span class="about">s</span><span class="about">g</span><span class="about">e</span><span class="about">n</span><span class="about">t</span><span class="about">s</span> <span class="about">s</span><span class="about">o</span><span class="about">c</span><span class="about">k</span><span class="about">s</span>
</h2>
                ...
                <p class="product-description">Step into comfort and style with the ietsgents Minimalistic Socks. Designed for everyday elegance, these socks feature a clean and understated aesthetic, making them the perfect addition to your essential wardrobe. Experience the perfect blend of simplicity and refinement with the ietsgents Minimalistic Socks, providing a sophisticated touch with every step.</p>
