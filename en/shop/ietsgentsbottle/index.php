    ...
    <main class="container">
        <div class="product-container">
            ...
            <div class="right-column">
                <h2 class="product-title"><span class="about">i</span><span class="about">e</span><span class="about">t</span><span class="about">s</span><span class="about">g</span><span class="about">e</span><span class="about">n</span><span class="about">t</span><span class="about">s</span> <span class="about">b</span><span class="about">o</span><span class="about">t</span><span class="about">t</span><span class="about">l</span><span class="about">e</span>
</h2>
                <div class="average-rating">
                          <p><?php echo generateStars($averageRating); ?></p>
                </div>
                <span class="product-price" data-original-price="25.00">19.99</span>

                <p class="product-description">Quench your thirst for style with the ietsgents Minimalistic Bottle. Crafted with a sleek design and high-quality materials, this bottle effortlessly blends form and function. Stay hydrated in style with the ietsgents Minimalistic Bottle - where elegance merges with everyday functionality.</p>
