    ...
    <main class="container">
        <div class="product-container">
            ...
            <div class="right-column">
                <h2 class="product-title"><span class="about">i</span><span class="about">e</span><span class="about">t</span><span class="about">s</span><span class="about">g</span><span class="about">e</span><span class="about">n</span><span class="about">t</span><span class="about">s</span> <span class="about">b</span><span class="about">e</span><span class="about">a</span><span class="about">n</span><span class="about">i</span><span class="about">e</span></h2>
                <div class="average-rating">
                          <p><?php echo generateStars($averageRating); ?></p>
                </div>
                <span class="product-price" data-original-price="25.00">24.99 EUR</span>

                <p class="product-description">Stay stylishly warm with the ietsgents minimalist beanie. This cozy essential embraces simplicity with a sleek design, providing a slim and versatile addition to your winter wardrobe. Elevate your winter look with the ietsgents minimalist beanie, where comfort merges with minimalist elegance.</p>
